...
-- 1번 주문
INSERT IGNORE INTO orders (id, order_no, price, quantity, status, created_by_customer_id, created_by_product_id,
...
-- 리뷰 1:
INSERT INTO review (grade, review_content, by_order_no, created_by_customer_id, created_by_product_id, created_at,
                    updated_at)
