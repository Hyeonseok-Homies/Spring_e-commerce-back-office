...
INSERT
IGNORE INTO admins (id, name, email, password, phone_number, role, status, created_at, updated_at, approved_at)
VALUES (1, '슈퍼관리자', 'admin@example.com', '$2a$04$7QTzheyj6jD3XDxvIjPW4OUb770j4j', '010-1111-1111', 'SUPER', 'ACTIVE', NOW(), NOW(), NOW());

-- 2. customers
INSERT
IGNORE INTO customers (Id, Name, Email, Password, Phone_Number, Created_At, Updated_At, Status)
VALUES (1, '테스트고객', 'customer@test.com', 'pass123', '010-2222-2222', NOW(), NOW(), 'ACTIVE');

-- 3. products (외래키 명칭: Created_By_Admin_Id)
INSERT
IGNORE INTO products (Id, Name, Category, Price, Stock, Status, Created_At, Updated_At, Created_By_Admin_Id)
