...
public class AdminController {
  ...
  public ResponseEntity<AdminListResponseDto> getAdminList(
      @ModelAttribute AdminListRequestDto requestDto) {
  ...
  public ResponseEntity<AdminResponseDto> updateAdmin(
      @PathVariable Long id, @Valid @RequestBody AdminUpdateRequestDto requestDto) {
  ...
  public ResponseEntity<AdminApprovalResponseDto> approveAdmin(
      @PathVariable Long id, @Valid @RequestBody AdminApprovalRequestDto requestDto) {
  ...
  public ResponseEntity<AdminRejectResponseDto> rejectAdmin(
      @PathVariable Long id, @Valid @RequestBody AdminRejectRequestDto requestDto) {
  ...
  public ResponseEntity<Void> changeAdminRole(
      @PathVariable Long id, @Valid @RequestBody AdminRoleUpdateDto requestDto) {
  ...
  public ResponseEntity<Void> changeStatus(
      @PathVariable Long id, @Valid @RequestBody AdminStatusUpdateDto requestDto) {
