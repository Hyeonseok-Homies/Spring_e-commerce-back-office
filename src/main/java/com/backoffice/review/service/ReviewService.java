...
public class ReviewService {
    ...
    public ReviewResponseDto getReviewAll(
            SessionAdmin admin, String keyword, Integer grade,
        ...
        List<ReviewResponseDto.ReviewListElementDto> dtoList = reviewPage.getContent().stream()
                .map(review -> ReviewResponseDto.ReviewListElementDto.builder()
                        .id(review.getId())
